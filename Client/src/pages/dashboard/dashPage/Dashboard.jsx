...
const Dashboard = () => {
    ...
    const { data: scholarships } = useSelector((state) => state.scholarship);
    ...
    const stats = [
        { label: "Total Leads", value: scholarships?.length || 0, icon: FileText, color: "text-blue-600", bg: "bg-blue-100" },
